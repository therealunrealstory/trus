...
function renderDonateButtons(root){
  ...
  if (provider === 'boosty') {
    ...
    a.href = url;
    // оставляем прямой текст, без i18n — чтобы не зависеть от локалей
    a.textContent = 'Support on Boosty';
    wrap.appendChild(a);

    // Инфо-кнопка (иконка) — использует существующие i18n-ключи для модалки
